...
const CommunityPartners = eventData.communityPartners

export default function CommunityPartnersContent() {
    return (
                ...
                <span className="text-sm sm:text-base font-medium text-left">
                  International Institute of Information Technology, Naya Raipur
                    ...
                    <div className="flex items-center justify-center w-full md:w-auto">
                        <Image
                            src="/images/communityPartners.svg"
            ...
            <div className="absolute left-0 bottom-[-20px] w-full z-20 pointer-events-none flex justify-center">
              ...
              />
                ...
                <section className="relative  h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                    <h2 className="text-5xl mt-16 sm:text-5xl font-bold text-center text-[#205c4b]">Community Partners</h2>

                                    <p className="text-center text-sm sm:text-base text-gray-700 mt-2 max-w-2xl mx-auto">Meet the passionate community partners behind DevFest Raipur 2025 — collaborating to empower developers, inspire innovation, and make this year’s event an unforgettable experience for the tech community.</p>

                                    <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                        {CommunityPartners.map((s) => (
                                            <Link href={s.linkedin} key={s.id} target="_blank" rel="noopener noreferrer">
